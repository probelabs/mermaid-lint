...
exports.coercePos = coercePos;
exports.endOfTextPos = endOfTextPos;
exports.codeFrame = codeFrame;
exports.fromLexerError = fromLexerError;
exports.mapFlowchartParserError = mapFlowchartParserError;
exports.mapPieParserError = mapPieParserError;
exports.mapSequenceParserError = mapSequenceParserError;
const quoteHygiene_js_1 = require("./quoteHygiene.js");
...
function codeFrame(text, line, column, length = 1, contextLines = 1) {
    const lines = text.split(/\r?\n/);
...
function expecting(err, tokenName) {
...
function mapSequenceParserError(err, text) {
    ...
    const atHeader = err?.context?.ruleStack?.[0] === 'diagram' && (err?.context?.ruleStack?.length === 1);
        ...
        if (blk) {
            ...
            if (openIdx !== -1) {
                ...
                if (caretLine > lines.length)
                    caretLine = lines.length + 1; // at EOF
            }
            return {
                line: caretLine,
                column: 1,
