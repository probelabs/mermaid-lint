...
exports.computeFixes = computeFixes;
const edits_js_1 = require("./edits.js");
// Helpers
function at(e) { return { line: e.line, column: e.column }; }
function is(code, e) { return e.code === code; }
function computeFixes(text, errors, level = 'safe') {
    const edits = [];
    const patchedLines = new Set();
    const seen = new Set();
    const piQuoteClosedLines = new Set();
    for (const e of errors) {
        ...
        if (is('FL-ARROW-INVALID', e)) {
            edits.push((0, edits_js_1.replaceRange)(text, at(e), e.length ?? 2, '-->'));
            continue;
        }
        if (is('FL-LABEL-ESCAPED-QUOTE', e)) {
            ...
            const lineText = (0, edits_js_1.lineTextAt)(text, e.line);
        ...
        if (is('FL-LABEL-DOUBLE-IN-DOUBLE', e)) {
            ...
            edits.push((0, edits_js_1.replaceRange)(text, at(e), e.length ?? 1, '&quot;'));
            continue;
        }
        ...
        if (is('FL-NODE-MIXED-BRACKETS', e)) {
            ...
            if (msg.includes("opened '['"))
                ...
                closer = '))';
            edits.push((0, edits_js_1.replaceRange)(text, at(e), e.length ?? 1, closer));
            continue;
        }
        if (is('FL-NODE-EMPTY', e)) {
            ...
            if (openIdx >= 0) {
                ...
                if (closeIdx !== -1) {
                    ...
                    edits.push((0, edits_js_1.replaceRange)(text, start, len, ''));
                }
            }
            continue;
        }
        if (is('FL-DIR-KW-INVALID', e)) {
            edits.push((0, edits_js_1.replaceRange)(text, at(e), e.length ?? 0, 'direction'));
            continue;
        }
        if (is('FL-DIR-MISSING', e)) {
            if (level === 'safe' || level === 'all') {
                // Default to TD
                edits.push((0, edits_js_1.insertAt)(text, at(e), ' TD'));
            }
            continue;
        }
        if (is('FL-LINK-MISSING', e)) {
            if (level === 'all')
                edits.push((0, edits_js_1.insertAt)(text, at(e), ' --> '));
            continue;
        }
            ...
            if (level === 'all') {
                ...
                if (dq % 2 === 1) {
                    ...
                    if (candidates.length) {
                        ...
                        edits.push((0, edits_js_1.insertAt)(text, { line: e.line, column: col }, '"'));
                    }
                }
            }
            continue;
        ...
        if (is('PI-LABEL-REQUIRES-QUOTES', e)) {
            ...
            if (colon > 0) {
                ...
                if (startIdx >= 0 && endIdx > startIdx) {
                    edits.push((0, edits_js_1.insertAt)(text, { line: e.line, column: startIdx + 1 }, '"'));
                    edits.push((0, edits_js_1.insertAt)(text, { line: e.line, column: endIdx + 1 }, '"'));
                }
            }
            continue;
        }
        if (is('PI-QUOTE-UNCLOSED', e)) {
            if (level === 'all') {
                ...
                edits.push((0, edits_js_1.insertAt)(text, { line: e.line, column: insertCol }, '"'));
        ...
        if (is('SE-MSG-COLON-MISSING', e)) {
            ...
            if (ai !== -1) {
                ...
                if (nextCh === ' ') {
                    ...
                    edits.push((0, edits_js_1.replaceRange)(text, { line: e.line, column: insertCol }, 1, ' : '));
                }
                else {
                    edits.push((0, edits_js_1.insertAt)(text, { line: e.line, column: insertCol }, ' : '));
                }
        ...
        if (is('SE-ELSE-IN-CRITICAL', e)) {
            edits.push((0, edits_js_1.replaceRange)(text, at(e), e.length ?? 4, 'option'));
            continue;
        }
        if (is('SE-BLOCK-MISSING-END', e)) {
            ...
            if (openIdx === -1) {
                ...
                const indent = (0, edits_js_1.inferIndentFromLine)(lines[curIdx] || '');
                edits.push((0, edits_js_1.insertAt)(text, { line: curIdx + 1, column: 1 }, `${indent}end\n`));
                continue;
            }
            ...
            for (let i = openIdx + 1; i < lines.length; i++) {
                ...
                if (raw.trim() === '')
                    continue;
                const ind = (0, edits_js_1.inferIndentFromLine)(raw);
            ...
            edits.push((0, edits_js_1.insertAt)(text, { line: insertLine + 1, column: 1 }, `${openIndent}end\n`));
            continue;
        }
        if (is('SE-AUTONUMBER-EXTRANEOUS', e)) {
            ...
            const indent = (0, edits_js_1.inferIndentFromLine)(lineText); // preserve original line indentation only
        ...
        if (is('FL-STRICT-LABEL-QUOTES-REQUIRED', e)) {
            if (level === 'all') {
                ...
                if (openIdx >= 0) {
                    ...
                    if (closeIdx > openIdx) {
                        edits.push((0, edits_js_1.insertAt)(text, { line: e.line, column: openIdx + 2 }, '"'));
                        edits.push((0, edits_js_1.insertAt)(text, { line: e.line, column: closeIdx + 1 }, '"'));
                    }
                }
            }
            continue;
