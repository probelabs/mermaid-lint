...
var Parser = class _Parser {
   ...
   */
  static performSelfAnalysis(parserInstance4) {
...
// out/diagrams/flowchart/lexer.js
...
var FlowchartKeyword = createToken({
  name: "FlowchartKeyword",
  pattern: /flowchart/,
  longer_alt: Identifier
});
var GraphKeyword = createToken({
  name: "GraphKeyword",
  pattern: /graph/,
  longer_alt: Identifier
});
var Direction = createToken({
  name: "Direction",
  pattern: /TD|TB|BT|RL|LR/,
  longer_alt: Identifier
});
var SubgraphKeyword = createToken({
  name: "SubgraphKeyword",
  pattern: /subgraph/,
  longer_alt: Identifier
});
var EndKeyword = createToken({
  name: "EndKeyword",
  pattern: /end/,
  longer_alt: Identifier
});
...
var StyleKeyword = createToken({
  name: "StyleKeyword",
  pattern: /style/,
  longer_alt: Identifier
});
var ClassDefKeyword = createToken({
  name: "ClassDefKeyword",
  pattern: /classDef/,
  longer_alt: Identifier
});
var Ampersand = createToken({
  name: "Ampersand",
  pattern: /&/
});
...
var TripleColon = createToken({
  name: "TripleColon",
  pattern: /:::/
});
var BiDirectionalArrow = createToken({
  name: "BiDirectionalArrow",
  pattern: /<-->/
});
var CircleEndLine = createToken({
  name: "CircleEndLine",
  pattern: /o--o|o---o|o----o/
});
var CrossEndLine = createToken({
  name: "CrossEndLine",
  pattern: /x--x|x---x|x----x/
});
var DottedArrowRight = createToken({
  name: "DottedArrowRight",
  pattern: /-\.->|-\.\.->|-\.\.\.->/
});
var DottedArrowLeft = createToken({
  name: "DottedArrowLeft",
  pattern: /<-\.-|<-\.\.-|<-\.\.\.-/
});
var ThickArrowRight = createToken({
  name: "ThickArrowRight",
  pattern: /==>|===>|====>/
});
var ThickArrowLeft = createToken({
  name: "ThickArrowLeft",
  pattern: /<==|<===|<====/
});
var ArrowRight = createToken({
  name: "ArrowRight",
  pattern: /-->|--->|---->/
});
var ArrowLeft = createToken({
  name: "ArrowLeft",
  pattern: /<--|<---|<----/
});
var DottedLine = createToken({
  name: "DottedLine",
  pattern: /-\.-|-\.\.-|-\.\.\.-/
});
var ThickLine = createToken({
  name: "ThickLine",
  pattern: /===|====|=====/
});
var Line = createToken({
  name: "Line",
  pattern: /---|----/
});
var TwoDashes = createToken({
  name: "TwoDashes",
  pattern: /--/
});
var InvalidArrow = createToken({
  name: "InvalidArrow",
  pattern: /->(?!>)/
});
var DoubleSquareOpen = createToken({ name: "DoubleSquareOpen", pattern: /\[\[/ });
var DoubleSquareClose = createToken({ name: "DoubleSquareClose", pattern: /\]\]/ });
var DoubleRoundOpen = createToken({ name: "DoubleRoundOpen", pattern: /\(\(/ });
var DoubleRoundClose = createToken({ name: "DoubleRoundClose", pattern: /\)\)/ });
var HexagonOpen = createToken({ name: "HexagonOpen", pattern: /\{\{/ });
var HexagonClose = createToken({ name: "HexagonClose", pattern: /\}\}/ });
var StadiumOpen = createToken({ name: "StadiumOpen", pattern: /\(\[/ });
var StadiumClose = createToken({ name: "StadiumClose", pattern: /\]\)/ });
var CylinderOpen = createToken({ name: "CylinderOpen", pattern: /\[\(/ });
var CylinderClose = createToken({ name: "CylinderClose", pattern: /\)\]/ });
var SquareOpen = createToken({ name: "SquareOpen", pattern: /\[/ });
var SquareClose = createToken({ name: "SquareClose", pattern: /\]/ });
var RoundOpen = createToken({ name: "RoundOpen", pattern: /\(/ });
var RoundClose = createToken({ name: "RoundClose", pattern: /\)/ });
var DiamondOpen = createToken({ name: "DiamondOpen", pattern: /\{/ });
var DiamondClose = createToken({ name: "DiamondClose", pattern: /\}/ });
var AngleOpen = createToken({ name: "AngleOpen", pattern: />/ });
var Pipe = createToken({ name: "Pipe", pattern: /\|/ });
var QuotedString = createToken({
  name: "QuotedString",
  pattern: /"[^"]*"|'[^']*'/
});
var MultilineText = createToken({
  name: "MultilineText",
  pattern: /"""[\s\S]*?"""/,
  line_breaks: true
});
...
var MermaidLexer = new Lexer(allTokens);
function tokenize(text) {
  const lexResult = MermaidLexer.tokenize(text);
  return lexResult;
}

// out/diagrams/flowchart/parser.js
var MermaidParser = class extends CstParser {
  constructor() {
    super(allTokens);
    this.diagram = this.RULE("diagram", () => {
      this.OR([
        { ALT: () => this.CONSUME(FlowchartKeyword) },
        { ALT: () => this.CONSUME(GraphKeyword) }
      ]);
    ...
    this.node = this.RULE("node", () => {
      this.OR([
        ...
        {
          ALT: () => {
            this.CONSUME2(NumberLiteral, { LABEL: "nodeIdNum" });
          }
        }
      ]);
      this.OPTION2(() => {
    ...
    this.nodeContent = this.RULE("nodeContent", () => {
      this.OR([
        ...
        { ALT: () => this.CONSUME(MultilineText) },
        {
          ALT: () => {
            this.AT_LEAST_ONE(() => {
              this.OR2([
                ...
                { ALT: () => this.CONSUME(TwoDashes) },
                { ALT: () => this.CONSUME(Line) },
                { ALT: () => this.CONSUME(ThickLine) },
                { ALT: () => this.CONSUME(DottedLine) }
              ]);
            });
          }
        }
    ...
    this.link = this.RULE("link", () => {
      this.OR([
        // Arrows with inline text (e.g., -.text.-> or ==text==>)
        {
          ALT: () => {
            ...
            this.OR3([
              ...
              { ALT: () => this.CONSUME(DottedArrowRight) },
              { ALT: () => this.CONSUME(ThickArrowRight) }
            ]);
          }
        },
        ...
        {
          ALT: () => {
            this.CONSUME(Text, { LABEL: "inlineCarrier" });
            this.CONSUME(AngleOpen);
          }
        },
        // Regular arrows/lines
        { ALT: () => this.CONSUME2(BiDirectionalArrow) },
        { ALT: () => this.CONSUME2(CircleEndLine) },
        { ALT: () => this.CONSUME2(CrossEndLine) },
        { ALT: () => this.CONSUME2(ArrowRight) },
        { ALT: () => this.CONSUME2(ArrowLeft) },
        { ALT: () => this.CONSUME2(DottedArrowRight) },
        { ALT: () => this.CONSUME2(DottedArrowLeft) },
        { ALT: () => this.CONSUME2(ThickArrowRight) },
        { ALT: () => this.CONSUME2(ThickArrowLeft) },
        { ALT: () => this.CONSUME2(Line) },
        { ALT: () => this.CONSUME2(DottedLine) },
        { ALT: () => this.CONSUME2(ThickLine) },
    ...
    this.directionStatement = this.RULE("directionStatement", () => {
      this.CONSUME(Identifier, { LABEL: "dirKw" });
      this.CONSUME(Direction);
    ...
    this.classStatement = this.RULE("classStatement", () => {
      ...
      this.CONSUME3(Identifier, { LABEL: "className" });
      this.OPTION(() => {
        this.CONSUME(Newline);
      });
    });
...
var parserInstance = new MermaidParser();
...
// out/diagrams/flowchart/semantics.js
var BaseVisitor = parserInstance.getBaseCstVisitorConstructorWithDefaults();
var FlowSemanticsVisitor = class extends BaseVisitor {
  constructor(ctx) {
    super();
  ...
  checkEmptyContent(openTok, contentNodes) {
    ...
    for (const cn of contentNodes) {
      ...
      const qs = [].concat(ch.QuotedString || []).concat(ch.MultilineText || []);
      for (const q of qs) {
        const img = q.image;
        if (!img)
          continue;
  ...
  checkEscapedQuotes(contentNodes) {
    ...
    for (const cn of contentNodes) {
      const ch = cn.children || {};
      const tokens = [].concat(ch.QuotedString || []).concat(ch.Text || []).concat(ch.Identifier || []).concat(ch.NumberLiteral || []);
  ...
  nodeShape(ctx) {
    const openTok = ctx.SquareOpen && ctx.SquareOpen[0] || ctx.DoubleSquareOpen && ctx.DoubleSquareOpen[0] || ctx.RoundOpen && ctx.RoundOpen[0] || ctx.DoubleRoundOpen && ctx.DoubleRoundOpen[0] || ctx.DiamondOpen && ctx.DiamondOpen[0] || ctx.HexagonOpen && ctx.HexagonOpen[0] || ctx.StadiumOpen && ctx.StadiumOpen[0] || ctx.CylinderOpen && ctx.CylinderOpen[0];
    const contentNodes = [];
    ...
    if (openTok) {
      ...
      if (this.ctx.strict) {
        ...
        for (const cn of contentNodes) {
          ...
          const candidates = [].concat(ch.Identifier || []).concat(ch.Text || []).concat(ch.NumberLiteral || []).concat(ch.RoundOpen || []).concat(ch.RoundClose || []).concat(ch.Comma || []).concat(ch.Colon || []).concat(ch.Pipe || []);
  ...
  for (const tok of tokens) {
    if (typeof tok.image === "string") {
      ...
      if (idx !== -1) {
        ...
        const { line, column } = coercePos(lineNo, col, 1, 1);
...
function coercePos(line, column, fallbackLine = 1, fallbackColumn = 1) {
  const ln = Number.isFinite(line) && line > 0 ? line : fallbackLine;
  const col = Number.isFinite(column) && column > 0 ? column : fallbackColumn;
  return { line: ln, column: col };
}
function endOfTextPos(text) {
  const lines = text.split(/\r?\n/);
  const line = lines.length;
  const last2 = lines[lines.length - 1] ?? "";
  const column = Math.max(1, last2.length + 1);
  return { line, column };
}
function fromLexerError(e) {
...
function isInRule(err, name) {
  const stack = err?.context?.ruleStack;
  return Array.isArray(stack) && stack.includes(name);
}
function expecting(err, tokenName2) {
  return (err.message || "").includes(`--> ${tokenName2} <--`);
}
function atHeader(err) {
  const stack = err?.context?.ruleStack;
  return Array.isArray(stack) && stack.length === 1 && stack[0] === "diagram";
}
function mapFlowchartParserError(err, text) {
  const tok = err.token;
  ...
  const len = typeof tok?.image === "string" && tok.image.length > 0 ? tok.image.length : 1;
  ...
  if (isInRule(err, "subgraph") && err.name === "NoViableAltException") {
    return {
      ...
      column,
      severity: "error",
      code: "FL-SUBGRAPH-MISSING-HEADER",
...
function mapPieParserError(err, text) {
  const tok = err.token;
  const posFallback = endOfTextPos(text);
  const { line, column } = coercePos(tok?.startLine ?? null, tok?.startColumn ?? null, posFallback.line, posFallback.column);
  const found = tokenImage(tok);
...
function mapSequenceParserError(err, text) {
  const tok = err.token;
  const posFallback = endOfTextPos(text);
  const { line, column } = coercePos(tok?.startLine ?? null, tok?.startColumn ?? null, posFallback.line, posFallback.column);
  const found = tokenImage(tok);
  ...
  const lines = text.split(/\r?\n/);
  const ltxt = lines[Math.max(0, line - 1)] || "";
  const inRule = (name) => isInRule(err, name);
  const inActorRefContext = inRule("actorRef") || inRule("participantDecl");
  const exp = (name) => expecting(err, name);
  const atHeader2 = err?.context?.ruleStack?.[0] === "diagram" && err?.context?.ruleStack?.length === 1;
  const branchRules = [
  ...
  const stack = err?.context?.ruleStack || [];
  const currentBlock = stack.slice().reverse().find((s) => /Block$/.test(s));
...
${br.example}`,
  ...
  if (atHeader2 && exp("SequenceKeyword")) {
  ...
  if (inActorRefContext && (err.name === "NoViableAltException" || err.name === "MismatchedTokenException" || err.name === "EarlyExitException")) {
    ...
    if (onLine)
      return { ...onLine, severity: "warning" };
  ...
  if (err.name === "MismatchedTokenException" && exp("EndKeyword")) {
    ...
    if (blk) {
      ...
      for (let i = Math.max(0, line - 1); i >= 0; i--) {
        const m = openerRe.exec(lines2[i] || "");
        if (m) {
          openIdx = i;
          openIndent = m[1] || "";
          break;
      ...
      if (openIdx !== -1) {
        ...
        if (caretLine > lines2.length)
          caretLine = lines2.length + 1;
      }
      return {
        line: caretLine,
        column: 1,
...
// out/diagrams/flowchart/validate.js
function validateFlowchart(text, options = {}) {
  return lintWithChevrotain(text, {
    tokenize,
    parse,
    analyze: (cst, tokens) => analyzeFlowchart(cst, tokens, { strict: !!options.strict }),
    ...
    postParse: (text2, tokens, _cst, prevErrors) => {
      ...
      const esc = detectEscapedQuotes(tokens, {
        code: "FL-LABEL-ESCAPED-QUOTE",
        message: 'Escaped quotes (\\") in node labels are not supported by Mermaid. Use &quot; instead.',
        hint: 'Prefer "He said &quot;Hi&quot;".'
      ...
      if (dq % 2 === 1 || sq % 2 === 1) {
        errs.push(...detectUnclosedQuotesInText(text2, {
...
// out/diagrams/pie/lexer.js
var PieKeyword = createToken({ name: "PieKeyword", pattern: /pie/ });
var TitleKeyword = createToken({ name: "TitleKeyword", pattern: /title/ });
var ShowDataKeyword = createToken({ name: "ShowDataKeyword", pattern: /showData/ });
var Colon2 = createToken({ name: "Colon", pattern: /:/ });
var NumberLiteral2 = createToken({ name: "NumberLiteral", pattern: /-?[0-9]+(\.[0-9]+)?/ });
var QuotedString2 = createToken({ name: "QuotedString", pattern: /"(?:\\.|[^"\\])*"|'(?:\\.|[^'\\])*'/ });
var Text2 = createToken({ name: "Text", pattern: /[^:\n\r]+/ });
var Comment2 = createToken({ name: "Comment", pattern: /%%[^\n\r]*/, group: Lexer.SKIPPED });
var WhiteSpace2 = createToken({ name: "WhiteSpace", pattern: /[ \t]+/, group: Lexer.SKIPPED });
var Newline2 = createToken({ name: "Newline", pattern: /[\n\r]+/, line_breaks: true });
var allTokens2 = [
  // skipped
  Comment2,
  // strings
...
var PieLexer = new Lexer(allTokens2);
function tokenize2(text) {
  return PieLexer.tokenize(text);
}

// out/diagrams/pie/parser.js
var PieParser = class extends CstParser {
  constructor() {
    super(allTokens2);
    this.diagram = this.RULE("diagram", () => {
      this.CONSUME(PieKeyword);
      this.OPTION(() => this.CONSUME(ShowDataKeyword));
      this.OPTION2(() => this.CONSUME(Newline2));
    ...
    this.statement = this.RULE("statement", () => {
      this.OR([
        ...
        { ALT: () => this.CONSUME(Newline2) }
      ]);
    });
    this.titleStmt = this.RULE("titleStmt", () => {
      this.CONSUME(TitleKeyword);
      this.AT_LEAST_ONE(() => this.OR([
        { ALT: () => this.CONSUME(QuotedString2) },
        { ALT: () => this.CONSUME(Text2) },
        { ALT: () => this.CONSUME(NumberLiteral2) }
      ]));
      this.OPTION2(() => this.CONSUME(Newline2));
    });
    this.sliceStmt = this.RULE("sliceStmt", () => {
      ...
      this.CONSUME(Colon2);
      this.CONSUME(NumberLiteral2);
      this.OPTION3(() => this.CONSUME(Newline2));
    });
    this.sliceLabel = this.RULE("sliceLabel", () => {
      this.CONSUME(QuotedString2);
    });
    this.performSelfAnalysis();
  }
};
var parserInstance2 = new PieParser();
function parse2(tokens) {
  parserInstance2.input = tokens;
  const cst = parserInstance2.diagram();
  return { cst, errors: parserInstance2.errors };
}

// out/diagrams/pie/semantics.js
var BaseVisitor2 = parserInstance2.getBaseCstVisitorConstructorWithDefaults();
var PieSemanticsVisitor = class extends BaseVisitor2 {
  constructor(ctx) {
    super();
    this.validateVisitor();
    this.ctx = ctx;
...
// out/diagrams/pie/validate.js
function validatePie(text, _options = {}) {
  return lintWithChevrotain(text, {
    tokenize: tokenize2,
    parse: parse2,
    analyze: (cst, tokens) => analyzePie(cst, tokens),
    mapParserError: (e, t) => mapPieParserError(e, t),
    postLex: (text2, tokens) => {
      const out = [];
      out.push(...detectUnclosedQuotesInText(text2, {
        code: "PI-QUOTE-UNCLOSED",
        message: "Unclosed quote in slice label.",
        hint: 'Close the quote: "Dogs" : 10',
        limitPerFile: 1
      ...
      const escapedLines = /* @__PURE__ */ new Set();
...
// out/diagrams/sequence/lexer.js
var Identifier2 = createToken({ name: "Identifier", pattern: /[A-Za-z_][A-Za-z0-9_]*/ });
var NumberLiteral3 = createToken({ name: "NumberLiteral", pattern: /[0-9]+/ });
var SequenceKeyword = createToken({ name: "SequenceKeyword", pattern: /sequenceDiagram/, longer_alt: Identifier2 });
var ParticipantKeyword = createToken({ name: "ParticipantKeyword", pattern: /participant/i, longer_alt: Identifier2 });
var ActorKeyword = createToken({ name: "ActorKeyword", pattern: /actor/i, longer_alt: Identifier2 });
var AsKeyword = createToken({ name: "AsKeyword", pattern: /as/i, longer_alt: Identifier2 });
var AutonumberKeyword = createToken({ name: "AutonumberKeyword", pattern: /autonumber/i, longer_alt: Identifier2 });
var OffKeyword = createToken({ name: "OffKeyword", pattern: /off/i, longer_alt: Identifier2 });
var NoteKeyword = createToken({ name: "NoteKeyword", pattern: /note/i, longer_alt: Identifier2 });
var LeftKeyword = createToken({ name: "LeftKeyword", pattern: /left/i, longer_alt: Identifier2 });
var RightKeyword = createToken({ name: "RightKeyword", pattern: /right/i, longer_alt: Identifier2 });
var OverKeyword = createToken({ name: "OverKeyword", pattern: /over/i, longer_alt: Identifier2 });
var OfKeyword = createToken({ name: "OfKeyword", pattern: /of/i, longer_alt: Identifier2 });
var ActivateKeyword = createToken({ name: "ActivateKeyword", pattern: /activate/i, longer_alt: Identifier2 });
var DeactivateKeyword = createToken({ name: "DeactivateKeyword", pattern: /deactivate/i, longer_alt: Identifier2 });
var CreateKeyword = createToken({ name: "CreateKeyword", pattern: /create/i, longer_alt: Identifier2 });
var DestroyKeyword = createToken({ name: "DestroyKeyword", pattern: /destroy/i, longer_alt: Identifier2 });
var AltKeyword = createToken({ name: "AltKeyword", pattern: /alt/i, longer_alt: Identifier2 });
var ElseKeyword = createToken({ name: "ElseKeyword", pattern: /else/i, longer_alt: Identifier2 });
var OptionKeyword = createToken({ name: "OptionKeyword", pattern: /option/i, longer_alt: Identifier2 });
var OptKeyword = createToken({ name: "OptKeyword", pattern: /opt/i, longer_alt: Identifier2 });
var LoopKeyword = createToken({ name: "LoopKeyword", pattern: /loop/i, longer_alt: Identifier2 });
var ParKeyword = createToken({ name: "ParKeyword", pattern: /par/i, longer_alt: Identifier2 });
var AndKeyword = createToken({ name: "AndKeyword", pattern: /and/i, longer_alt: Identifier2 });
var RectKeyword = createToken({ name: "RectKeyword", pattern: /rect/i, longer_alt: Identifier2 });
var CriticalKeyword = createToken({ name: "CriticalKeyword", pattern: /critical/i, longer_alt: Identifier2 });
var BoxKeyword = createToken({ name: "BoxKeyword", pattern: /box/i, longer_alt: Identifier2 });
var EndKeyword2 = createToken({ name: "EndKeyword", pattern: /end/i, longer_alt: Identifier2 });
var LinksKeyword = createToken({ name: "LinksKeyword", pattern: /links/i, longer_alt: Identifier2 });
var LinkKeyword = createToken({ name: "LinkKeyword", pattern: /link/i, longer_alt: Identifier2 });
var BreakKeyword = createToken({ name: "BreakKeyword", pattern: /break/i, longer_alt: Identifier2 });
var BidirAsyncDotted = createToken({ name: "BidirAsyncDotted", pattern: /<<-->>/ });
var BidirAsync = createToken({ name: "BidirAsync", pattern: /<<->>/ });
var DottedAsync = createToken({ name: "DottedAsync", pattern: /-->>/ });
var Async = createToken({ name: "Async", pattern: /->>/ });
var Dotted = createToken({ name: "Dotted", pattern: /-->/ });
var Solid = createToken({ name: "Solid", pattern: /->/ });
var DottedCross = createToken({ name: "DottedCross", pattern: /--x/ });
var Cross = createToken({ name: "Cross", pattern: /-x/ });
var DottedOpen = createToken({ name: "DottedOpen", pattern: /--\)/ });
var Open = createToken({ name: "Open", pattern: /-\)/ });
var Plus = createToken({ name: "Plus", pattern: /\+/ });
var Minus = createToken({ name: "Minus", pattern: /-/ });
var Comma2 = createToken({ name: "Comma", pattern: /,/ });
var Colon3 = createToken({ name: "Colon", pattern: /:/ });
var LParen = createToken({ name: "LParen", pattern: /\(/ });
var RParen = createToken({ name: "RParen", pattern: /\)/ });
var QuotedString3 = createToken({ name: "QuotedString", pattern: /"(?:\\.|[^"\\])*"|'(?:\\.|[^'\\])*'/ });
var Comment3 = createToken({ name: "Comment", pattern: /%%[^\n\r]*/, group: Lexer.SKIPPED });
var WhiteSpace3 = createToken({ name: "WhiteSpace", pattern: /[ \t]+/, group: Lexer.SKIPPED });
var Newline3 = createToken({ name: "Newline", pattern: /[\n\r]+/, line_breaks: true });
var Text3 = createToken({ name: "Text", pattern: /[^\n\r]+/ });
var allTokens3 = [
  // Skip
  Comment3,
  // Strings
...
var SequenceLexer = new Lexer(allTokens3);
function tokenize3(text) {
  return SequenceLexer.tokenize(text);
}

// out/diagrams/sequence/parser.js
var SequenceParser = class extends CstParser {
  constructor() {
    super(allTokens3);
    this.diagram = this.RULE("diagram", () => {
      this.CONSUME(SequenceKeyword);
      this.MANY(() => this.CONSUME(Newline3));
      this.MANY2(() => {
    ...
    this.actorRef = this.RULE("actorRef", () => {
      this.AT_LEAST_ONE(() => this.OR([
        { ALT: () => this.CONSUME(Identifier2) },
        { ALT: () => this.CONSUME(QuotedString3) },
        { ALT: () => this.CONSUME(NumberLiteral3) },
        { ALT: () => this.CONSUME(Text3) }
      ]));
    });
    this.participantDecl = this.RULE("participantDecl", () => {
      this.OR([
        { ALT: () => this.CONSUME(ParticipantKeyword) },
        { ALT: () => this.CONSUME(ActorKeyword) }
      ]);
    ...
    this.autonumberStmt = this.RULE("autonumberStmt", () => {
      this.CONSUME(AutonumberKeyword);
      this.OPTION(() => {
        this.OR([
          { ALT: () => this.CONSUME(OffKeyword) },
          { ALT: () => {
            this.CONSUME(NumberLiteral3);
            this.OPTION2(() => this.CONSUME2(NumberLiteral3));
          } }
        ]);
      });
      this.AT_LEAST_ONE(() => this.CONSUME(Newline3));
    ...
    this.activateStmt = this.RULE("activateStmt", () => {
      this.CONSUME(ActivateKeyword);
      this.SUBRULE(this.actorRef);
      this.AT_LEAST_ONE(() => this.CONSUME(Newline3));
    });
    this.deactivateStmt = this.RULE("deactivateStmt", () => {
      this.CONSUME(DeactivateKeyword);
      this.SUBRULE(this.actorRef);
      this.AT_LEAST_ONE(() => this.CONSUME(Newline3));
    });
    this.createStmt = this.RULE("createStmt", () => {
      this.CONSUME(CreateKeyword);
      this.OR([
        { ALT: () => this.CONSUME(ParticipantKeyword) },
        { ALT: () => this.CONSUME(ActorKeyword) }
      ]);
    ...
    this.linkStmt = this.RULE("linkStmt", () => {
      this.OR([
        { ALT: () => this.CONSUME(LinkKeyword) },
        { ALT: () => this.CONSUME(LinksKeyword) }
      ]);
      this.SUBRULE(this.actorRef);
      this.CONSUME(Colon3);
    ...
    this.arrow = this.RULE("arrow", () => {
      this.OR([
        { ALT: () => this.CONSUME(BidirAsyncDotted) },
        { ALT: () => this.CONSUME(BidirAsync) },
        { ALT: () => this.CONSUME(DottedAsync) },
        { ALT: () => this.CONSUME(Async) },
        { ALT: () => this.CONSUME(Dotted) },
        { ALT: () => this.CONSUME(Solid) },
        { ALT: () => this.CONSUME(DottedCross) },
        { ALT: () => this.CONSUME(Cross) },
        { ALT: () => this.CONSUME(DottedOpen) },
        { ALT: () => this.CONSUME(Open) }
      ]);
    });
    this.altBlock = this.RULE("altBlock", () => {
      this.CONSUME(AltKeyword);
      this.OPTION(() => this.SUBRULE(this.lineRemainder));
      this.AT_LEAST_ONE(() => this.CONSUME(Newline3));
      ...
      this.AT_LEAST_ONE3(() => this.CONSUME3(Newline3));
    });
    this.optBlock = this.RULE("optBlock", () => {
      this.CONSUME(OptKeyword);
      this.OPTION(() => this.SUBRULE(this.lineRemainder));
      this.AT_LEAST_ONE(() => this.CONSUME(Newline3));
      this.MANY(() => this.SUBRULE(this.line));
      this.CONSUME(EndKeyword2);
    ...
    this.lineRemainder = this.RULE("lineRemainder", () => {
      this.AT_LEAST_ONE(() => this.OR([
        ...
        { ALT: () => this.CONSUME(Plus) },
        { ALT: () => this.CONSUME(Minus) },
        { ALT: () => this.CONSUME(Comma2) },
        { ALT: () => this.CONSUME(Colon3) },
        { ALT: () => this.CONSUME(LParen) },
        { ALT: () => this.CONSUME(RParen) },
        // Allow any keywords if they happen to appear in text
        { ALT: () => this.CONSUME(AndKeyword) },
        { ALT: () => this.CONSUME(ElseKeyword) },
        { ALT: () => this.CONSUME(OptKeyword) },
        { ALT: () => this.CONSUME(OptionKeyword) },
        { ALT: () => this.CONSUME(LoopKeyword) },
        { ALT: () => this.CONSUME(ParKeyword) },
        { ALT: () => this.CONSUME(RectKeyword) },
        { ALT: () => this.CONSUME(CriticalKeyword) },
        ...
        { ALT: () => this.CONSUME(OfKeyword) },
        { ALT: () => this.CONSUME(AutonumberKeyword) },
        { ALT: () => this.CONSUME(OffKeyword) },
        { ALT: () => this.CONSUME(LinkKeyword) },
        { ALT: () => this.CONSUME(LinksKeyword) },
        { ALT: () => this.CONSUME(CreateKeyword) },
        { ALT: () => this.CONSUME(DestroyKeyword) },
        { ALT: () => this.CONSUME(ParticipantKeyword) },
        { ALT: () => this.CONSUME(ActorKeyword) },
        { ALT: () => this.CONSUME(ActivateKeyword) },
        { ALT: () => this.CONSUME(DeactivateKeyword) }
      ]));
    });
    this.performSelfAnalysis();
  }
};
var parserInstance3 = new SequenceParser();
function parse3(tokens) {
  parserInstance3.input = tokens;
  const cst = parserInstance3.diagram();
  return { cst, errors: parserInstance3.errors };
}

// out/diagrams/sequence/semantics.js
var BaseVisitor3 = parserInstance3.getBaseCstVisitorConstructorWithDefaults();
var SequenceSemanticsVisitor = class extends BaseVisitor3 {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    this.validateVisitor();
...
// out/diagrams/sequence/validate.js
function validateSequence(text, options = {}) {
  return lintWithChevrotain(text, {
    ...
    postParse: (text2, tokens, _cst, prevErrors) => {
      ...
      const hasPar = tokenList.some((x) => x.tokenType === ParKeyword);
      const hasAnd = tokenList.some((x) => x.tokenType === AndKeyword);
      const hasAlt = tokenList.some((x) => x.tokenType === AltKeyword);
      const hasElse = tokenList.some((x) => x.tokenType === ElseKeyword);
      const hadErrors = prevErrors.some((e) => e.severity === "error");
      if (hadErrors) {
        if (!prevErrors.some((e) => e.code === "SE-QUOTE-UNCLOSED")) {
          const unc = detectUnclosedQuotesInText(text2, {
            code: "SE-QUOTE-UNCLOSED",
            message: "Unclosed quote in participant/actor name.",
            hint: 'Close the quote: participant "Bob"  or  participant Alice as "Alias"',
            limitPerFile: 1
        ...
        if (hasAnd && !hasPar && !hasAndOutsideParErr) {
          const first2 = tokenList.find((x) => x.tokenType === AndKeyword);
          warnings.push({
            ...
            length: first2.image?.length ?? 3
          });
        }
        if (hasElse && !hasAlt && !hasElseOutsideAltErr) {
          const first2 = tokenList.find((x) => x.tokenType === ElseKeyword);
          warnings.push({
            line: first2.startLine ?? 1,
            column: first2.startColumn ?? 1,
            severity: "warning",
...
function isOtherMermaidDiagram(headerLine) {
  if (!headerLine)
    return false;
...
function textReport(filename, content, errors) {
  const { errs, warns } = groupErrors(errors);
  const lines = [];
  const printBlock = (kind, e) => {
    ...
    const fmtNum = (n) => String(n).padStart(numWidth, " ");
    const idx = Math.max(0, Math.min(allLines.length - 1, e.line - 1));
    const prev = idx > 0 ? allLines[idx - 1] : void 0;
    const text = allLines[idx] ?? "";
    const next = idx + 1 < allLines.length ? allLines[idx + 1] : void 0;
    if (e.code === "SE-BLOCK-MISSING-END" || e.code === "SE-ELSE-IN-CRITICAL") {
      ...
      if (typeof prev === "string")
        lines.push(`  ${fmtNum(e.line - 1)} | ${prev}`);
      ...
      if (typeof next === "string")
        lines.push(`  ${fmtNum(e.line + 1)} | ${next}`);
    }
    if (e.hint) {
  ...
  for (const w of warns)
    printBlock("warning", w);
  if (errs.length === 0 && warns.length === 0)
    return "Valid";
  return lines.join("\n");
}
function toJsonResult(filename, errors) {
  const { errs, warns } = groupErrors(errors);
  return {
    file: filename,
    valid: errs.length === 0,
...
function computeFixes(text, errors, level = "safe") {
  const edits = [];
  ...
  for (const e of errors) {
      ...
      if (level === "safe" || level === "all") {
        ...
        if (sqOpen !== -1 && sqClose !== -1 && sqClose > sqOpen) {
          ...
          if (innerSeg.includes('"')) {
            ...
            if (core.length >= 2 && isSlashPair(left, right)) {
              ...
              const replacedMid = mid.split("&quot;").join("\0").split('"').join("&quot;").split("\0").join("&quot;");
              newInner = ltrim + left + replacedMid + right + rtrim;
            } else {
              const replaced = innerSeg.split("&quot;").join("\0").split('"').join("&quot;").split("\0").join("&quot;");
              newInner = '"' + replaced + '"';
            }
        ...
        if (opened) {
          if (opened.open === "{") {
            ...
            if (dj !== -1 && dj + 1 === opened.idx)
              opened = { open: "{{", close: "}}", idx: dj, len: 2 };
          } else if (opened.open === "[") {
            const jj = lineText.lastIndexOf("[[", caret0);
            const cj = lineText.lastIndexOf("[(", caret0);
            if (jj !== -1 && jj === opened.idx)
              opened = { open: "[[", close: "]]", idx: jj, len: 2 };
            else if (cj !== -1 && cj === opened.idx)
              opened = { open: "[(", close: ")]", idx: cj, len: 2 };
          } else if (opened.open === "(") {
            const jj = lineText.lastIndexOf("((", caret0);
            ...
            if (jj !== -1 && jj === opened.idx)
              opened = { open: "((", close: "))", idx: jj, len: 2 };
            else if (sj !== -1 && sj === opened.idx - 1)
              opened = { open: "([", close: "])", idx: sj, len: 2 };
            else if (cj2 !== -1 && cj2 === opened.idx - 1)
              opened = { open: "[(", close: ")]", idx: cj2, len: 2 };
          }
        }
        let closer = "]";
        if (opened)
      ...
      if (level === "all") {
        ...
        if (dq % 2 === 1) {
          ...
          if (candidates.length) {
            ...
            const col = (ins.idx >= 0 ? ins.idx : lineText.length) + 1;
    ...
    if (is("PI-QUOTE-UNCLOSED", e)) {
      if (level === "all") {
        if (piQuoteClosedLines.has(e.line))
          continue;
        const lineText = lineTextAt(text, e.line);
        const colon = lineText.indexOf(":");
    ...
    if (is("SE-MSG-COLON-MISSING", e)) {
      ...
      if (ai !== -1) {
        ...
        if (lineText[i] === '"' || lineText[i] === "'") {
          ...
          while (j < lineText.length && !/\s/.test(lineText[j]) && lineText[j] !== ":")
            j++;
        }
        const insertCol = j + 1;
